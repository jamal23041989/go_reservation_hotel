...
func (s *MongoRoomRepository) CreateRoom(ctx context.Context, room *models.Room) (*models.Room, error) {
...
func (s *MongoRoomRepository) GetRooms(ctx context.Context, filter domain.Map) ([]*models.Room, error) {
