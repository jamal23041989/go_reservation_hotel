...
func (s *MongoUserRepository) GetUserByID(ctx context.Context, id string) (*models.User, error) {
...
func (s *MongoUserRepository) GetUsers(ctx context.Context) ([]*models.User, error) {
...
func (s *MongoUserRepository) GetByEmailUser(ctx context.Context, email string) (*models.User, error) {
	var user models.User
...
func (s *MongoUserRepository) CreateUser(ctx context.Context, user *models.User) (*models.User, error) {
