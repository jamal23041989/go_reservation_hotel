...
type RoomHandler struct {
	roomUsecase    service.RoomService
	bookingUsecase service.BookingService
}

func NewRoomHandler(roomUsecase service.RoomService, bookingUsecase service.BookingService) *RoomHandler {
	return &RoomHandler{
...
func (h *RoomHandler) HandleBookRoom(c *fiber.Ctx) error {
	...
	user, ok := c.Context().Value("user").(entity.User)
	if !ok {
