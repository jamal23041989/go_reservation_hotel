...
func (s *MongoBookingRepository) CreateBooking(ctx context.Context, booking *entity.Booking) (*entity.Booking, error) {
...
func (s *MongoBookingRepository) GetBookings(ctx context.Context, filter domain.Map) ([]*entity.Booking, error) {
...
func (s *MongoBookingRepository) GetBookingByID(ctx context.Context, id string) (*entity.Booking, error) {
